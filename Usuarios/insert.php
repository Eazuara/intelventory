...
if (isset($_POST['submit']))
{
   ...
   $query = "INSERT INTO usuario (ID_Usuario, Nombre_Usuario,Sexo, Fecha_Nacimiento, Mail, Contrasena) VALUES ('$ID', '$Nombre', '$Sexo ', '$Bdate','$Mail','$Contra')";
      ...
      <div class="container">
        <form action="insert.php" method = "POST">
          <p>
            ...
            Sexo:<br>
            <input type="radio" name="sexo" value="M" checked> M<br>
            <input type="radio" name="sexo" value="F"> F<br>
            Fecha Nacimiento: <input type="date" name="fecha"><br>
            Mail:  &nbsp;  &nbsp;  &nbsp;  &nbsp; <input type="email" name="mail"><br>
            Contrasena: <input type="password" name="contra"><br>

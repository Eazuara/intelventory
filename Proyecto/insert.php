...
if (isset($_POST['submit']))
{
   ...
   $query = "INSERT INTO proyecto (ID_Proyecto, Nombre_Proyecto,Fecha_Inicio, Descripcion,ID_Usuario) VALUES ('$ID', '$Nombre', '$Ini ', '$Desc','$IDU')";
    ...
    <body>
      <div class="container">
        <form action="insert.php" method = "POST">
          <p>
            Nº de proyecto: <input type="text" name="id"><br>
            Nombre: <input type="text" name="nombre"><br>
            Fecha de Inicio: <input type="date" name="fecha"><br>
            Descripcion:  &nbsp;  &nbsp;  &nbsp;  &nbsp; <input type="text" name="desc"><br>
            ID_Usuario: <input type="text" name="us"><br>

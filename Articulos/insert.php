...
if (isset($_POST['submit']))
{
   ...
   $query = "INSERT INTO articulo (SKU, Nombre, Categoria, Descripcion,Unidad,Stock) VALUES ('$SKU', '$Nombre', '$Categoria', '$Descripcion','$Unidad','$Stock')";
      ...
      <div class="container">
        <form action="insert.php" method = "POST">
          <p>
            ...
            Stock: <input type="number" name="stock" min ="1" max="255"><br>
